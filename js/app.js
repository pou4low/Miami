(() => {
    ...
    window.onscroll = function showHeader() {
        ...
        let mainH = document.querySelector(".main").clientHeight;
        if (window.pageYOffset > mainH - 450) header.classList.add("header_fixed"); else header.classList.remove("header_fixed");
    };
    window["FLS"] = true;
    isWebp();
    menuInit();
